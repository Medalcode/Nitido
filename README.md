...
| Base de datos | PostgreSQL (Integrado con SQLAlchemy) |
...
│   ├── app/
│   │   ├── services/  # parser (con OCR Tesseract), summarizer, risk_detector, corpus
│   │   ├── models/    # Pydantic schemas y database.py (SQLAlchemy)
│   │   ├── api/       # Endpoints REST
